...
nice bash makeOptFlow.sh ./${filename}/frame_%05d-1.ppm ./${filename}/flow_768-1 1 ${opt_res:-2} &
nice bash makeOptFlow.sh ./${filename}/frame_%05d-2.ppm ./${filename}/flow_768-2 1 ${opt_res:-2} &
nice bash makeOptFlow.sh ./${filename}/frame_%05d-3.ppm ./${filename}/flow_768-3 1 ${opt_res:-2} &
nice bash makeOptFlow.sh ./${filename}/frame_%05d-4.ppm ./${filename}/flow_768-4 1 ${opt_res:-2} &
nice bash makeOptFlow.sh ./${filename}/frame_%05d-5.ppm ./${filename}/flow_768-5 1 ${opt_res:-2} &
nice bash makeOptFlow.sh ./${filename}/frame_%05d-6.ppm ./${filename}/flow_768-6 1 ${opt_res:-2} &
